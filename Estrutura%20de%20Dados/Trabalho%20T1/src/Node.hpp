...
class Node {
 public:
	...
	//! Construtor polimórfico para Node.
	/*!	Usado para criar o Node com dado, Node anterior e proximo Node.
	 * 	\param prev um tipo Node*.
	 * 	\param next um tipo Node*.
	 * 	\sa Node(const T& data), Node()
	 */
    ...
    //! Função membro prev | anterior.
	/*!	Getter para o Node* antecedente.
	 *	\return um Node*.
	 */
    Node* prev() { return prev_; }

    //! Função membro prev const.
	/*!	Getter para o Node* antecedente.
	 *	\return um const Node*.
	 */
    const Node* prev() const { return prev_; }

    //! Função membro prev com parametros.
	/*!	Setter para o Node* antecedente.
 ...
 private:
    ...
    //! Variavel privada prev_ .
	/*!	Ponteiro do tipo Node responsavel por guardar a posição do Node anterior.
	 */
    Node* prev_ { nullptr };
